...
export const issueApi = {
  ...
  /** 状态流转（返回版本号 + 动作执行结果） */
  transitStatus(id: string, statusId: string, comment?: string, version?: number, force?: boolean, forceWip?: boolean, forceDescEmpty?: boolean, assigneeId?: string, assigneeExplicit?: boolean, customFieldValues?: Record<string, string>) {
    return request.post<any, R<TransitStatusResultVO>>(`/issues/${id}/transitions`, { statusId, comment, version, force, forceWip, forceDescEmpty, assigneeId, assigneeExplicit, customFieldValues })
  },
