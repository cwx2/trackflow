...
const activityActionLabels: Record<string, string> = {
  ...
  comment_restored: '恢复了评论',
  comment_permanently_deleted: '永久删除了评论',
  action_rule_executed: '执行了自动化规则',
  actions_auto_disabled: '自动禁用了动作',
  workflow_updated: '更新了工作流',
  create_sprint: '创建了迭代',
