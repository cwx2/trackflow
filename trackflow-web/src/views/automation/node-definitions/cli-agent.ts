...
export const cliAgentDefinition: NodeDefinition = {
  ...
  inputPorts: [
    { name: 'prompt',  valueType: 'string', required: true,  description: '提示词，支持引用上游变量' },
    { name: 'workDir', valueType: 'string', required: false, description: '工作目录，默认为 {workspace}' },
  ],
  outputPorts: [
    { name: 'output',   valueType: 'string', description: '命令行完整输出内容' },
    { name: 'exitCode', valueType: 'number', description: '退出码，0 表示成功' },
  ],
  configFields: [
