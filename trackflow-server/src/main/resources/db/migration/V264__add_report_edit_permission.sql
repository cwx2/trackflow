-- V264__add_report_edit_permission.sql
...
INSERT INTO sys_permission (code, name, category, scope, description)
VALUES ('report:edit', '编辑报表', 'report', 'project', '编辑、删除、管理报表共享')
