 ...
 * <p>
 * 批量场景下，调用方预加载 option/user/group 映射表后注入此上下文，
 * 避免每个 Handler 单独查库。
 *
 * @author TrackFlow
 * @since 1.0
...
public record DisplayContext(
    ...
    public static final DisplayContext EMPTY = new DisplayContext(Map.of(), Map.of(), Map.of());
    ...
    public static DisplayContext of(Map<Long, String> optionTextMap, Map<Long, String> userNameMap, Map<Long, String> groupNameMap) {
        return new DisplayContext(
                optionTextMap != null ? optionTextMap : Map.of(),
                userNameMap != null ? userNameMap : Map.of(),
                groupNameMap != null ? groupNameMap : Map.of()
        );
    }
}
